...
with tab1:
    ...
    col120, col121, col122, col123, col124, col125 = st.columns([0.1, 0.4, 0.1, 0.1, 0.1, 0.2])
    with col120:
        st.info("이름")
    with col121:
...
with tab2:
    ...
    week_list_df['주별'] = week_list_df['datetime'].dt.strftime("%Y년-%m월-%U주")
    ...
    month_list_df['월별'] = month_list_df['datetime'].dt.strftime("%Y년-%m월")
